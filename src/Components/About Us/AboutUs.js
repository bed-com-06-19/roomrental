    ...
    <>
      <div className="border">
        <div className="border grid grid-cols-1 md:grid-cols-2 bg-black">
          <div className="textDiv bg-black">
          ...
          <div className="rightDiv flex justify-center items-center p-4 md:p-8">
            <img src={about} alt="About Us" className="rounded-3xl max-w-full h-auto"/>
          </div>
        </div>
      </div>
    </>
