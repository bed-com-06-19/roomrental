...
import MYBACKGROUND from '../../COMPONENT/assets/Vintagedeskphone.jpg'; // Ensure this path is correct

const Login = () => {
  return (
    <div
      className="flex items-center justify-center min-h-screen"
      style={{ backgroundImage: `url(${MYBACKGROUND})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
    >
