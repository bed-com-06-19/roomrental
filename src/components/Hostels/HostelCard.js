...
const HostelCard = ({ name, image, distance, price, location, gender, rating }) => {
  return (
    <div className="bg-black text-white rounded-lg overflow-hidden shadow-md transform transition-transform hover:scale-105">
...
const HardHostelCards = () => {
  ...
  const hostels = [
    ...
    { name: "Petite hostel", image: hostel1, distance: "1 mile", price: "40000MWK", location: "Downtown", gender: "females", rating: 3 },
    { name: "Petite hostel", image: hostel1, distance: "4 miles", price: "40000MWK", location: "Suburb", gender: "males", rating: 5 },
    { name: "Hostel C", image: hostel1, distance: "5miles", price: "40000MWK", location: "Rural", gender: "males", rating: 5 },
