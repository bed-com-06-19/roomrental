...
const ContactUs = () => {
  return (
    ...
    >
      <div className="text-2xl mb-4 font-bold">CONTACT US</div>
      <h1 className="flex items-center text-center">
        Have a question or need assistance? We're here to help! Simply fill out
        the form below and we'll get back to you as soon as possible. Your
