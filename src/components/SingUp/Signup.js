...
const Signup = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl bg-black bg-opacity-50 text-color shadow-md rounded-lg px-8 py-12">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <div className="text-white mb-2">Phone Number</div>
            <div className="mb-4">
              <input
                type="tel"
                name="phone"
            ...
            <div className="text-white mb-2">Full Name</div>
            <div className="mb-4">
              <input
                type="text"
                name="fullName"
