...
function LandingPage() {
  return (
    <div
      className="w-full min-h-screen max-h-fit bg-cover bg-center"
      style={{
        backgroundImage:
      ...
      <div className="flex flex-col bg-gradient-to-t from-black via-black/30 h-screen items-center">
        ...
        <div className="w-7/10 h-[70vh] mt-12 flex flex-col justify-center items-center text-white">
          ...
          <p className="text-lg font-bold m-0">
            ...
            rooms and landloards to post their available hostels.
          </p>
          <p className="text-lg font-bold m-0">
            It offers the best way for every student around universty of malawi
            to find accommodation.
          </p>
          <div>
            <Link
              to="/Hostel"
              className="no-underline w-32 h-12 bg-green-500 text-black flex justify-center items-center rounded-full mt-16 hover:bg-white hover:text-black"
            >
